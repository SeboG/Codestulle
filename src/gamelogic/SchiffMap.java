...
public class SchiffMap {
	...
	public boolean setzeSchiffNeu(int x, int y, boolean horizontal, int groesse) {
		...
		if(horizontal) {
			if(x < (rand) && y < 11 ) {
				switch(groesse) {
					case 1: if(this.pruefeAngrenzende(x,y)) {
								this.feld[x][y] = 1;
								System.out.print("1er "); 
							}
							else { System.out.print("Kein "); }
							break;
					case 2: if(this.pruefeAngrenzende(x,y) && this.pruefeAngrenzende(x+1,y)) {
								this.feld[x][y] = 1; 
								this.feld[x+1][y] = 1; 
							...
							break;
					case 3: if(this.pruefeAngrenzende(x,y) && this.pruefeAngrenzende(x+1,y) && this.pruefeAngrenzende(x+2,y)) {
								this.feld[x][y] = 1; 	
								this.feld[x+1][y] = 1; 
								this.feld[x+2][y] = 1; 
							...
							break;
					case 4: if(this.pruefeAngrenzende(x,y) && this.pruefeAngrenzende(x+1,y) && this.pruefeAngrenzende(x+2,y) && this.pruefeAngrenzende(x+3,y)) {
								this.feld[x][y] = 1; 
								this.feld[x+1][y] = 1; 
								this.feld[x+2][y] = 1; 
								this.feld[x+3][y] = 1; 
							...
							break;
					case 5: if(this.pruefeAngrenzende(x,y)) {
								this.feld[x][y] = 5;
			...
			if(y < (rand) && x < 11 ) {
					switch(groesse) {
						case 1: if(this.pruefeAngrenzende(x,y)) {
								...
								break;
						case 2: if(this.pruefeAngrenzende(x,y) && this.pruefeAngrenzende(x,y+1)) {
									this.feld[x][y] = 1; 
									this.feld[x][y+1] = 1; 
									System.out.print("2er "); 
								}
								...
								break;
						case 3: if(this.pruefeAngrenzende(x,y) && this.pruefeAngrenzende(x,y+1) && this.pruefeAngrenzende(x,y+2)) {
									this.feld[x][y] = 1; 	
									this.feld[x][y+1] = 1; 
									this.feld[x][y+2] = 1; 
									System.out.print("3er "); 
								...
								break;
						case 4: if(this.pruefeAngrenzende(x,y) && this.pruefeAngrenzende(x,y+1) && this.pruefeAngrenzende(x,y+2) && this.pruefeAngrenzende(x,y+3)) {
									this.feld[x][y] = 1; 
									this.feld[x][y+1] = 1; 
									this.feld[x][y+2] = 1; 
									this.feld[x][y+3] = 1; 
	...
	public int schuss(int y, int x) {
		//return 0: nichts getroffen, return 1: treffer, return 2: treffer versenkt, return 3: alle versenkt
		if(feld[x][y] == 1) {
			feld[x][y] = -1;
	...
	public boolean pruefeAngrenzende(int x, int y) {
		if(this.feld[x-1][y]<1 && this.feld[x+1][y]<1 && this.feld[x][y-1]<1 && this.feld[x][y+1]<1 && this.feld[x+1][y+1]<1 && this.feld[x+1][y-1]<1 && this.feld[x-1][y-1]<1 && this.feld[x-1][y+1]<1) {
	...
	public boolean pruefeAngrenzendeAlt(int x, int y) {
		...
		if(x>0 && y>0) {
			...
			if(this.feld[x+1][y]<1 && this.feld[x][y-1]<1 && this.feld[x][y+1]<1 && this.feld[x+1][y+1]<1 && this.feld[x+1][y-1]<1){
				System.out.println("---Kein Schiff grenzt an");
				return true;
			}
		}
		else if(y==0) {
			if(this.feld[x+1][y]<1 && this.feld[x-1][y]<1 && this.feld[x][y+1]<1 && this.feld[x+1][y+1]<1 && this.feld[x-1][y+1]<1){
				System.out.println("---Kein Schiff grenzt an");
				return true;
			}
		}
...
public boolean setzeSchiff(int y, int x, boolean horizontal, boolean groesse) {
	...
	if(horizontal) {
		if(this.pruefeAngrenzende(x,y) && this.pruefeAngrenzende(x+1,y)) {
			if( !groesse || (groesse && this.pruefeAngrenzende(x+2,y)) ) {
				if(x < (rand) && y < 8 ) {
					this.feld[x][y] = 1;
					this.feld[x+1][y] = 1;
					if(groesse) {
						this.feld[x+2][y] = 1;
						System.out.print("Grosses ");
					}
					this.schiffCounter++;
					System.out.println("Schiff erstellt");
					return true;
		...
		if(x < 8 && y < (rand) ) {
			if(this.pruefeAngrenzende(x,y) && this.pruefeAngrenzende(x,y+1)) {
				if( !groesse || (groesse && this.pruefeAngrenzende(x,y+2)) ) {
